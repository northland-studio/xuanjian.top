// 聊天 / 支付相关 SVG 图标（替代 emoji，风格统一、可调色）
...
/** 银行卡 / 支付 */
export function CardIcon({ size = 40, color = 'currentColor', style }) {
  return (
...
/** 成功（对勾圆圈） */
export function CheckCircleIcon({ size = 48, color = '#1e9e6a', style }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
/** 警告（三角感叹号） */
export function AlertIcon({ size = 40, color = '#e0a800', style }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
/** 收起（横线） */
export function CollapseIcon({ size = 18, color = 'currentColor', style }) {
  return (
...
/** 图片 */
export function ImageIcon({ size = 18, color = 'currentColor', style }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
/** 表情（笑脸） */
export function SmileIcon({ size = 18, color = 'currentColor', style }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}>
      <circle cx="12" cy="12" r="10" />
...
/** 发送（纸飞机） */
export function SendIcon({ size = 18, color = 'currentColor', style }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
/** 购物袋（商城） */
export function BagIcon({ size = 18, color = 'currentColor', style }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}>
