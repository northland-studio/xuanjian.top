...
import { CheckCircleIcon } from './ChatIcons';
...
/**
 * 支付管理面板（管理员）：待审批 / 对账概览 / 全量流水（含 CSV 导出）/ 风控阈值
 * 同时被两处复用：独立页面 /pay/admin，以及站点管理后台的「支付管理」分页。
 */
export default function PayAdminPanel() {
  const { user } = useAuth();
