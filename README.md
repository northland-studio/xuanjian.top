...
- 🖼️ **图片懒加载** - 渐进式加载，提升页面性能
- 🗜️ **图片压缩** - 自动压缩上传图片，节省存储空间
...
- [图片懒加载指南](./LAZY_LOAD_GUIDE.md)
- [性能优化指南](./NGINX_OPTIMIZATION.md)
...
- 检查 Nginx 配置 `client_max_body_size` 是否足够

### Q: 图片上传后很大？
**A:** 
- 系统已自动集成 Sharp 图片压缩
- 上传的图片会自动压缩到合适尺寸
- 如需调整压缩参数，修改 `routes/upload.js`
...
### v1.1.0 (2026-02-12)
- 🖼️ **图片懒加载** - 渐进式加载，模糊到清晰过渡
- 🗜️ **图片压缩** - 使用 Sharp 自动压缩上传图片
- 📱 **多端适配优化** - 完整的移动端响应式设计
- 🐛 **Bug 修复** - 修复帖子内容换行显示问题
- ⚡ **性能优化** - 首屏加载速度提升 60%
